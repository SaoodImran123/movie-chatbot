...
productionCompaniesData = collectionTMDB_Production_Companies.find({})
...
ageRestrictionWords = ["children", "adult", "child", "kid", "R rated", "PG rated", "rated R", "rated PG", "younger audience", "appropriate", "inappropriate", "lewd", "family"]
languages = []
...
with open(r"production_companies.txt", "rb") as f:
    pc = pickle.load(f)